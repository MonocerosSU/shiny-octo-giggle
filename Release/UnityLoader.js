        ...
        return function e(t, n, o) {
            ...
            8: [function(e, t, n) {
                ...
                function f(e, t) {
                    ...
                    return e.next_out = s, e.avail_out = d, e.next_in = r, e.avail_in = l, n.hold = f, n.bits = h, (n.wsize || p !== e.avail_out && n.mode < ce && (n.mode < le || t !== M)) && c(e, e.output, e.next_out, p - e.avail_out) ? (n.mode = fe, A) : (m -= e.avail_in, p -= e.avail_out, e.total_in += m, e.total_out += p, n.total += p, n.wrap && p && (e.adler = n.check = n.flags ? v(n.check, a, p, e.next_out - p) : g(n.check, a, p, e.next_out - p)), e.data_type = n.bits + (n.last ? 64 : 0) + (n.mode === J ? 128 : 0) + (n.mode === te || n.mode === X ? 256 : 0), (0 === m && 0 === p || t === M) && xe === R && (xe = z), xe)
                }
            ...
            9: [function(e, t, n) {
                ...
                t.exports = function(e, t, n, m, p, b, w, g) {
                    ...
                    if (A > B && (A = B), 0 === B) return p[b++] = 20971520, p[b++] = 20971520, g.bits = 1, 0;
                    for (L = 1; B > L && 0 === N[L]; L++);
                    for (L > A && (A = L), U = 1, F = 1; i >= F; F++)
                        if (U <<= 1, U -= N[F], 0 > U) return -1;
                    if (U > 0 && (e === s || 1 !== B)) return -1;
                    for (q[1] = 0, F = 1; i > F; F++) q[F + 1] = q[F] + N[F];
                    for (D = 0; m > D; D++) 0 !== t[n + D] && (w[q[t[n + D]]++] = D);
                    if (e === s ? (P = G = w, S = 19) : e === l ? (P = u, T -= 257, G = c, j -= 257, S = 256) : (P = f, G = h, S = -1), Z = 0, D = 0, F = L, x = b, z = A, I = 0, y = -1, O = 1 << A, _ = O - 1, e === l && O > a || e === d && O > r) return 1;
                    for (var H = 0;;) {
                        H++, M = F - I, w[D] < S ? (C = 0, E = w[D]) : w[D] > S ? (C = G[j + w[D]], E = P[T + w[D]]) : (C = 96, E = 0), v = 1 << F - I, k = 1 << z, L = k;
                        ...
                        if (F > A && (Z & _) !== y) {
                            for (0 === I && (I = A), x += L, z = F - I, U = 1 << z; B > z + I && (U -= N[z + I], !(0 >= U));) z++, U <<= 1;
                            if (O += 1 << z, e === l && O > a || e === d && O > r) return 1;
                            y = Z & _, p[y] = A << 24 | z << 16 | x - b | 0
                        }
                    }
                    return 0 !== Z && (p[x + Z] = F - I << 24 | 64 << 16 | 0), g.bits = A, 0
                }
            }, {
                "../utils/common": 1
            }],
    ...
    function() {
        var e = function(e) {
            ...
            function n() {
                ...
                }, new t(0, 7204250, 0, 0).open("GET", "/data.unity3d"), new t(7204250, 7204438, 0, 0).open("GET", "/methods_pointedto_by_uievents.xml"), new t(7204438, 9054930, 0, 0).open("GET", "/Il2CppData/Metadata/global-metadata.dat"), new t(9054930, 10551622, 0, 0).open("GET", "/Resources/unity_default_resources"), new t(10551622, 10579248, 0, 0).open("GET", "/Managed/mono/2.0/machine.config"), Module.addRunDependency("datafile_WebGLBuild.data"), Module.preloadResults || (Module.preloadResults = {}), Module.preloadResults[i] = {
                    fromCache: !1
                }, l ? (n(l), l = null) : d = n
            }
            var o;
